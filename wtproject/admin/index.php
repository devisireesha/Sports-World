              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select * from customer")or die ("query 1 incorrect.....");

                        while(list($user_id,$first_name,$last_name,$email,$password,$phone,$gender,$dob)=mysqli_fetch_array($result))
                        {	
                        echo "<tr><td>$user_id</td><td>$first_name</td><td>$last_name</td><td>$email</td><td>$password</td><td>$phone</td><td>$gender</td><td>$dob</td>
                  ...
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        ...
                        {	
                            $sql = "SELECT COUNT(*) AS count_items FROM prdt WHERE sport_name='$cat_title'";
