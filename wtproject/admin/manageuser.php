...
/*this is delet quer*/
mysqli_query($con,"delete from customer where user_id='$user_id'")or die("query is incorrect...");
}
...
?>
	...
	<th><a href="adduser.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select user_id, username, password from customer")or die ("query 2 incorrect.......");
