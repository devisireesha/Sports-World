...
$result=mysqli_query($con,"select user_id,fname,lname, username, password from customer where user_id='$user_id'")or die ("query 1 incorrect.......");
...
mysqli_query($con,"update customer set fname='$first_name', lname='$last_name', username='$email', password='$user_password' where user_id='$user_id'")or die("Query 2 is inncorrect..........");
